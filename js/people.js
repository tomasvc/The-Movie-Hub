...
function getPeople(x) {
    axios
        .get(
            "https://api.themoviedb.org/3/person/popular?api_key=4f3fdbd8c5943719506e53611dd7be34&language=en-US&page=" +
                x
        )
        .then((response) => {
            ...
            <a href="#" onclick="personSelected(${
                ...
                <img src="${
                    data.results[i].profile_path != null
            ...
            if (x == 1 && response.data.total_pages > 1) {
                navString += `<a href="#" onclick="getPeople(${
                    x + 1
                })">Next page</a>`;
...
function getPerson() {
    ...
    axios
        ...
        .then((response) => {
            ...
            <div class="info-right">
                ...
                <p class="birthday">${
                    person.birthday != null ? "Born: " + person.birthday : ""
                }</p><p class="deathday">${
                person.deathday != null ? "Died: " + person.deathday : ""
            }</p>
                <p class="biography">${
    ...
    axios
        .get(
            "https://api.themoviedb.org/3/person/" +
                personId +
                "/external_ids?api_key=4f3fdbd8c5943719506e53611dd7be34"
        )
        .then((response) => {
        ...
        <ul class="external-ids">
            ${
                id.facebook_id != null
                    ? '<li class="id"><a href="https://www.facebook.com/' +
                      id.facebook_id +
            ...
            ${
                id.twitter_id != null
                    ? '<li class="id"><a href="https://www.twitter.com/' +
                      id.twitter_id +
                      '" target="_blank"><i class="fab fa-twitter"></i></a></li>'
                    : ""
            }
            ${
                id.instagram_id != null
                    ? '<li class="id"><a href="https://www.instagram.com/' +
                      id.instagram_id +
            ...
            ${
                id.imdb_id != null
                    ? '<li class="id"><a href="https://www.imdb.com/name/' +
                      id.imdb_id +
                      '" target="_blank"><i class="fab fa-imdb"></i></a></li>'
                    : ""
            }
        </ul>
        `;
    ...
    axios
        .get(
            "https://api.themoviedb.org/3/person/" +
                personId +
                "/combined_credits?api_key=4f3fdbd8c5943719506e53611dd7be34"
        )
        .then((response) => {
            let person = response.data;
            let string = ``;
            ...
            if (person.length != 0) {
                ...
                for (let i = 0; i <= 7; i++) {
                    person.cast.forEach((el) => {
                        if (
                            el.popularity >= popularity &&
                            !cast.includes(el.title) &&
                            !cast.includes(el.name)
                        ) {
                            ...
                            obj.backdrop != null
                                ? (obj.backdrop =
                                      ...
                                      el.backdrop_path)
                                : (obj.backdrop = "img/blank_image.png");
                    ...
                    person.crew.forEach((el) => {
                        if (
                            el.popularity >= popularity &&
                            !crew.includes(el.title) &&
                            !crew.includes(el.name)
                        ) {
                            popularity = el.popularity;
                            obj.popularity = el.popularity;
                            obj.backdrop != null
