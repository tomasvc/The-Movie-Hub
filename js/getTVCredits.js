function getTVCredits() {
    ...
    axios
        ...
        .then((response) => {
            ...
            let string = `<div><a href="#" onclick="TVSelected(${TVId})"><img src="https://image.tmdb.org/t/p/w300/${
                tv.poster_path
            }" class="credits-poster"></a></div>
        <div><a href="#" onclick="TVSelected(${TVId})"><p class="credits-title">${
                tv.original_name
            }</p></a><span class="credits-date">(${tv.first_air_date.substring(
                0,
                4
            )})</span>
